        ...
        <div className="flex flex-col min-h-screen">
            <div className="mx-auto container max-w-6xl p-3 pt-10">
                ...
                <div className="md:mb-28 mb-10">
                    <p className="text-zinc-700 dark:text-zinc-400 leading-8 text-lg">
                ...
                <div className="md:mb-28 mb-10">
                    <section className=" flex flex-col gap-y-2">
                        ...
                        <div className="flex flex-wrap gap-4 my-4">
                            <motion.div className="flex items-center px-4 py-1 text-sm border rounded-full border-zinc-400 dark:border-zinc-600 gap-x-2 cursor-pointer hover:border-amber-500 transition-all ">
                                <svg
                ...
                <div className="">
                    <main className="min-h-[calc(100vh_-_132px)] ">
                        <h2 className="mb-5 text-xl md:text-3xl font-medium flex items-center gap-3">Work
                            <svg className="w-8 h-8 text-zinc-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" strokeWidth="2" d="M8 7H5a2 2 0 0 0-2 2v4m5-6h8M8 7V5a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2m0 0h3a2 2 0 0 1 2 2v4m0 0v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-6m18 0s-4 2-9 2-9-2-9-2m9-2h.01" />
                            </svg>
